"""
Client module for llamastyles-package.
"""
...
class Client:
    """Main client for interacting with the llamastyles-package API."""
    ...
    def __init__(self, api_key=None, base_url=None, config=None):
        ...
        self.base_url = base_url or "https://api.llamasearch.ai/llamastyles-package"
