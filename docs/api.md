...
## llamastyles-package API

### Class: Client

The main client interface for interacting with the llamastyles-package library.
...
def process(self, query, options=None):
    """
    Process a query using the llamastyles-package engine.
