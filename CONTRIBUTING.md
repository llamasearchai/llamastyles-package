# Contributing to LlamaStyles Package

Thank you for your interest in contributing to LlamaStyles Package! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaStyles Package:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamastyles-package.git
   cd llamastyles-package
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamastyles-package.git
   ```
...
By contributing to LlamaStyles Package, you agree that your contributions will be licensed under the project's MIT License.
